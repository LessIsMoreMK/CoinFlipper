...
namespace CoinFlipper.Core
{
    ...
    public class ChatMessageListViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// The text to search for in this search command
        /// </summary>
        ...
        /// <summary>
        /// The command for when the user want to clear the search text
        /// </summary>
        ...
        /// <summary>
        /// When the pop-up click away areas is clicked hide any pup-ups
        /// </summary>
