...
namespace CoinFlipper.Core
{
    ...
    public interface IEmailTemplateSender
    {
        ...
        /// </summary>
        /// <param name="detials">The email message details. Note the Content property is ignored and replaced with the template</param>
        ...
        /// <returns></returns>
        Task<SendEmailResponse> SendGeneralEmailAsync(SendEmailDetails detials, string title, string content1, string content2, string buttonText, string buttonUrl);
    }
}
